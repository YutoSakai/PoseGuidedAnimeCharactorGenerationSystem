...
if __name__ == '__main__':
    ...
    print(Pb.dtype)
    print(Ib.dtype)
    # vutils.save_image(torch.from_numpy(np.transpose(Ib, [2, 0, 1])), 'out/Ia_vutils_test.png')
    # vutils.save_image(torch.from_numpy(np.transpose(Ib, [2, 0, 1])), 'out/Ib_vutils_test.png')
